...
class GetFacultyDocumentsUseCase implements UseCase<DocumentListEntity, GetFacultyDocumentsParams> {
  final DocumentRepository documentRepository;

  const GetFacultyDocumentsUseCase(this.documentRepository);

  @override
  Future<Either<Failure, DocumentListEntity>> call(GetFacultyDocumentsParams params) {
    return documentRepository.getFacultyDocuments(
      page: params.page,
