...
class ELITAuthenticatedDetailsModel {
  final String id;
  final String sub;
  final String name;
  final String email;
  ...
  factory ELITAuthenticatedDetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    return ELITAuthenticatedDetailsModel(
